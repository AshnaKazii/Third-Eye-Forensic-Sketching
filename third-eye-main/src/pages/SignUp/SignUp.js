        ...
        .then((userCredential) => {
            ...
            return user.updateProfile({
                ...
                .then(() => {
                    ...
                    localStorage.setItem("verificationMessage", "A verification email has been sent. Please check your inbox before logging in.");
                    
                    // Sign out immediately after registration
                    fire.auth().signOut();
                })
                .catch((emailError) => {
                    setFireErrors("Error sending verification email. Please try again later.");
                });
            });
        })
        .catch((error) => {
